...
<div role="tabpanel" class="tab-pane" id="ticket_form">
    ...
    <textarea class="form-control" rows="2"><iframe width="600" height="850" src="<?php echo site_url('appointly/appointments_public/form'); ?>" frameborder="0" allowfullscreen></iframe></textarea>
