...
$lang['sales_pipeline_source_estimate_expiry']            = 'Hạn Báo giá';
...
$lang['sales_pipeline_smart_prompt_expiry']                = 'Hạn Báo giá';
...
$lang['sales_pipeline_settings_performance_heading'] = 'Cấu hình Điểm hiệu suất';
$lang['sales_pipeline_settings_performance_help'] = 'Thiết lập các chỉ số mục tiêu để đánh giá điểm hiệu suất cho nhân viên.';
$lang['performance_response_target_percent_label'] = 'Mục tiêu tỷ lệ phản hồi đúng hạn (%)';
$lang['performance_response_target_percent_help'] = 'Tỷ lệ phản hồi nhắc nhở đúng hạn theo SLA để đạt điểm chuẩn 100 (mặc định 90%).';
