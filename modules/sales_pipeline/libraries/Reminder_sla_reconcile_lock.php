...
class Reminder_sla_reconcile_lock
{
    private $CI;
    ...
    public function acquire($timeoutSeconds = 0)
    {
        ...
        $row = $this->CI->db->query(
            ...
            [$this->lockName(), (int) $timeoutSeconds]
        )->row_array();
    ...
    {
        return db_prefix() . ':sales_pipeline:reconciler:sla';
    }
}
