...
function pr_chat_load_js()
{
    ...
    if (CHAT_CURRENT_URI === '/admin/prchat/prchat_controller/chat_full_view') {
        /**
         * Audio record js
         */
        echo '<script src="' . base_url('modules/prchat/assets/js/audio/WebAudioRecorder.min.js' . '?v=' . VERSIONING . '') . '"></script>';
        echo '<script src="' . base_url('modules/prchat/assets/js/audio/WebAudioRecorderOgg.min.js' . '?v=' . VERSIONING . '') . '"></script>';
        echo '<script src="' . base_url('modules/prchat/assets/js/audio/sound_app.js' . '?v=' . VERSIONING . '') . '"></script>';
    }
}
