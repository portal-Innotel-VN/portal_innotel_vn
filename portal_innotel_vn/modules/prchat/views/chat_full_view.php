...
<div id="wrapper" class="desktop_chat">
  ...
  <?php loadChatComponent('AudioComponent');  ?>
  ...
  <script>
    ...
    $("#frame").on('keypress', 'textarea.chatbox', function(e) {
      ...
      if (e.which == 13) {
        ...
        var langMessageSent = "<?= _l('chat_message_you') . ' ' . _l('chat_new_audio_message_sent'); ?>";

        $('#contacts .contact.active').find('.wrap .meta .preview').html('<?php echo _l('chat_message_you'); ?>' + ' ' + message.match('type="audio/ogg"&gt;&lt;/audio&gt') ? langMessageSent : message);
