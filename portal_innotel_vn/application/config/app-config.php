...
*
*/
define('APP_BASE_URL', 'https://portal.innotel.vn/');
...
*/
define('APP_ENC_KEY', 'ca02c8e34cd194b54a144f98cba15c26');
 ...
 */
define('APP_DB_USERNAME', 'kdolvina_innportalu');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'VCS~4}rAS8-2');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'kdolvina_innportal');
