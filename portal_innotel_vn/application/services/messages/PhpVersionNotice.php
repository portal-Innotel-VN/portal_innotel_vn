...
class PhpVersionNotice extends AbstractMessage
{
    ...
    public function getMessage()
    {
        ...
        <p>
           <b>
                IMPORTANT: The next major version release, the CRM will require at least php 7.4, it's strongly recommended to upgrade your PHP version so you can continue to use new and improved versions of the application.
           </b>
        </p>
        <hr />
